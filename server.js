...
/*for Kubernetes .yml files */
// Import necessary modules and configure other settings (above this section)
...
app.use(
  session({
    ...
    store: new MongoStore({
      url: "mongodb://mongo-service:27017/my-db", // Update with your service name
    }),
    cookie: {
      // milliseconds
